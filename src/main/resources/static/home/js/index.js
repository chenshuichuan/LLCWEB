$(document).ready(function () {
    var paper_url = "../limitPapers?currentPage=1&pageSize=15";
    gainJSON(paper_url, paperJSON);
...
function getPaperPage(page) {
    var paper_url = "../limitTeamPaper?currentPage=" + page + "&pageSize=15";
    getPaperByPage(page, 15, paperJSON);
}
...
function page() {
    var totalPage;
    $.ajax({
        url: '../limitPapers?currentPage=1&pageSize=15',
        async: false,
        dataType: 'json',
